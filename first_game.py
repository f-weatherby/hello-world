# Forrest Weatherby (efw5xb)
# Partners: Phil Head (aph8tb), Diva C (dc5zd)
...
def tick(keys):
    ...
    if int(seconds) == 0:
        ...
        camera.draw(gamebox.from_text(400, 400, "Your score: " + str(score), "arial", 30, "white"))
        camera.draw(gamebox.from_text(400, 450, "Congratulations, you survived to the end!", "arial", 30, "white"))
        gamebox.pause()
    camera.display()
ticks_per_second = 50
